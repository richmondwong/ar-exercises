...
@mens_stores = Store.where(mens_apparel: true).inspect

# @menus_stores.each {|i| puts i}

# puts @mens_stores


@womens_stores = Store.where("annual_revenue < 1000000", womens_apparel: true).inspect
puts @womens_stores